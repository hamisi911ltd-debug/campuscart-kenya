...
export const ProductCard = ({ p }: { p: Product }) => {
  ...
  return (
    <div className="group flex w-full flex-col overflow-hidden rounded-xl bg-card shadow-card transition-all hover:-translate-y-0.5 hover:shadow-elevated">
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        >
          <Heart
            className={`h-4 w-4 transition ${liked ? "fill-accent text-accent" : "text-muted-foreground"}`}
          />
        </button>
      </div>
